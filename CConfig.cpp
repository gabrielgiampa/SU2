...
void CConfig::SetConfig_Options() {
  ...
  addBoolOption("SPHERICAL_COORDINATES", spherical_coords, false);
  addDoubleOption("FIELD_STRENGTH", field_strength, 0.0);
  addDoubleOption("PLANET_MASS", planet_mass, -1.0);
  addDoubleOption("PLANET_RADIUS", planet_radius, 1e6);
  addDoubleArrayOption("CENTER_OF_MASS", 3, center_mass, default_COM);
