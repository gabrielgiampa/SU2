...
private:
  ...
  *Electric_Field_Dir;              /*!< \brief Direction of the electric field. */
  ...
  su2double field_strength;
  su2double planet_mass;
  su2double planet_radius;
  su2double *center_mass;
  su2double default_COM[3] = {0,0,0};
...
public:
  ...
  */
  ...
  bool GetSpherical(void) const {return spherical_coords;}

  const su2double* GetCenter_of_Mass(void) const {return center_mass;}

  const su2double GetField_Strength(void) const {return field_strength;}

  const su2double GetPlanet_Mass(void) const {return planet_mass;}

  const su2double GetPlanet_Radius(void) const {return planet_radius;}
