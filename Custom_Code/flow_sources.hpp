...
public:
  ...
  //ResidualType<> ComputeResidual(const CConfig* config, su2double[], su2double) override;

};

class CSphericalBodyForce final : public CSourceBase_Flow{
  su2double field_strength;

public:

  CSphericalBodyForce(unsigned short val_nDim, unsigned short val_nVar, const CConfig* config);
